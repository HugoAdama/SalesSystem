                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            ?>
                                                            <input type="text" class="form-control" value="<?php echo "P-" . codigo($contador_id_productos); ?>" disabled>
                                                            <input type="text" name="codigo" value="<?php echo "P-" . codigo($contador_id_productos); ?>" hidden>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="nombre" class="form-control" placeholder="Ingrese nombre del producto" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea name="descripcion" id="" cols="30" rows="1" class="form-control" placeholder="Ingrese descripcion del producto"></textarea>
                                                        </div>
                                                    </div>
                                                </div>
