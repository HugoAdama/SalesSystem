...
$sql_compras = "SELECT * , 
                ...
                cat.nombre_categoria as nombre_categoria ,us.nombres as nombres_usuario_producto,
                prov.nombre_proveedor as nombre_proveedor, prov.celular as celular_proveedor ,
                prov.telefono as telefono_proveedor, prov.empresa as empresa, prov.email as email_proveedor, 
